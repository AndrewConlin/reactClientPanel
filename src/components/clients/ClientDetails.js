...
class ClientDetails extends Component {
  ...
  handelOnDeleteClick = e => {
    const { firestore, client } = this.props;
    firestore.delete({ collection: 'clients', doc: client.id }).then(res => {
  ...
  render() {
    ...
    if (showBalanceUpdate) {
      balanceForm = (
        <form onSubmit={this.handelBalanceOnSubmit}>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="btn-group float-right">
                ...
                <button className="btn btn-danger" onClick={this.handelOnDeleteClick}>
                  Delete
                </button>
              </div>
            </div>
